    ...
    <div className={`w-full h-screen overflow-hidden relative bg-base-100`}>
      <div className={`h-screen overflow-hidden flex`}>
        <div className="flex max-h-screen overflow-hidden ">
          <div className={`flex flex-row h-screen w-250`}>
            <div className={`w-60`}>
              <LeftNavEntire setEditing={setEditing} />
            </div>
            <div className={`bg-base-100 flex-grow overflow-y-scroll no-scrollbar flex-col h-screen border-r border-base-300 z-40 relative drop-shadow-lg`}>
