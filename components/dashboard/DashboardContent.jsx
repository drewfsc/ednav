        ...
        <div>
          {selectedClient && (
            <div className={`grid grid-cols-3 gap-3 w-full`}>
              <div
                className={`col-span-3 bg-base-300 min-h-10 py-2 px-4 rounded flex items-center justify-between font-normal`}
              >
              ...
              <div
                className={`col-span-1 bg-base-200 min-h-80 rounded overflow-clip`}
              >
