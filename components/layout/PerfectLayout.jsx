    ...
    <div className={`w-full h-screen overflow-hidden relative bg-base-100`}>
      ...
      <div className={`w-full flex flex-row h-screen`}>
        ...
        <div className={`flex h-screen`}>
          ...
          <div
            className={`w-[250px] box-border 2xl:w-[320px] overflow-y-scroll no-scrollbar flex-col h-screen z-40 relative drop-shadow-lg `}
          >
            <ClientTable />
          </div>
        </div>
        ...
        >
          ...
          <div
            className={`relative ${editing === "add-client" ? "w-full  translate-x-0" : "translate-x-[4000px] collapse w-0"}`}
          >
            <AddClientForm />
          </div>
        </div>
