  ...
  if (type === 'textarea') {
    return (
      <div className="relative col-span-2">
        ...
        >{label}</label>
          <textarea name={name} placeholder={label} value={value} onChange={handleChange} className="input w-full border p-2 rounded-md relative z-0 min-h-32"/>
    ...
    return (
      <div className="relative">
        <label
          ...
          className="absolute z-10 -top-2 left-2 inline-block rounded-lg  px-1 text-xs font-medium text-base-content bg-base-300"
        >{label}</label>
          <select name={name} value={value} onChange={handleChange} className="input w-full border p-2 rounded-md relative z-0">
