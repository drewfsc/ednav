  ...
  const [buttonState, setButtonState] = useState('Active')
    return (
      ...
      <button
          ...
          className={`relative inline-flex items-center rounded-l-full pl-4 pr-2 text-xs text-black hover:text-white focus:z-10 hover:bg-green-600 ${buttonState === 'Active' ? 'bg-green-500 hover:bg-green-600 text-white hover:text-white' : ''}`}
      >
      ...
      <button
          ...
          className={`relative inline-flex items-center px-2  text-xs text-black hover:text-white focus:z-10 hover:bg-amber-400 ${buttonState === 'In Progress' ? 'bg-amber-500 hover:bg-amber-400 text-white ' : ''}`}
      >
      ...
      <button
          ...
          className={`relative inline-flex items-center px-2  text-xs focus:z-10 hover:bg-purple-500 hover:text-white ${buttonState === 'Graduated' ? 'bg-purple-600 hover:bg-purple-500 text-white hover:text-white' : ''}`}
      >
      ...
      <button
          ...
          className={`relative inline-flex items-center px-2 py-1.5 text-xs  focus:z-10 hover:text-white  hover:bg-red-500 ${buttonState === 'Inactive' ? 'bg-red-500 hover:bg-red-600 text-white ' : ''}`}
      >
          <span className={`text-[11px] leading-none`}>Inactive</span> <span className={`bg-red-600 rounded-full p-1 flex items-center w-auto ml-1`}><ProhibitInset size={14} className={`text-white`} /></span>
            ...
            <button
                ...
                className={`relative inline-flex items-center rounded-r-full pl-3 pr-4  text-xs focus:z-10 hover:bg-gray-300 ${buttonState === 'All' ? 'bg-gray-200 hover:bg-gray-300 text-black hover:text-black' : ''}`}
            >
